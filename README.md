...
3. Render reads `render.yaml`, sets build/start commands, and provisions a persistent disk for SQLite.
4. Add or confirm environment variables if needed (`JWT_SECRET` is auto-generated by Render Blueprint).
